    ...
    <div className="report-diagnostic-col">
      ...
      <div className="report-tva-chart">
        {LEVELS.map((lvl, idx) => {
          ...
          const thoughtPercent = normalizeLikertToPercent(thought);
          const actionPercent = normalizeLikertToPercent(action);
          return (
            <div key={lvl} className="report-tva-group">
              ...
              <div className="report-tva-track">
                <div className="report-tva-track-fill" style={{ width: `${thoughtPercent}%`, background: THOUGHT_COLOR }} />
              </div>
              <span className="report-tva-track-label">Action</span>
              <div className="report-tva-track">
                <div className="report-tva-track-fill" style={{ width: `${actionPercent}%`, background: ACTION_COLOR }} />
              </div>
            </div>
          );
        })}
