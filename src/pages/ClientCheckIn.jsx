              ...
              <div key={level} className="space-y-2">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex justify-between text-xs text-gray-500">
                    <span>Rarely</span>
                    <span className="font-medium text-gray-700">{["Rarely","Occasionally","Sometimes","Often","Frequently"][form[`thought_l${level}`] - 1]}</span>
            ...
            {levelConfig.map(({ level, label, color }) => (
              <div key={level} className="space-y-2">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex justify-between text-xs text-gray-500">
                    <span>Rarely</span>
                    <span className="font-medium text-gray-700">{["Rarely","Occasionally","Sometimes","Often","Frequently"][form[`action_l${level}`] - 1]}</span>
                    <span>Frequently</span>
                  </div>
                </div>
              </div>
